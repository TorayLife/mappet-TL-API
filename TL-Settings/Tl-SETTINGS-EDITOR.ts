...
function main(c: IScriptEvent) {
	 ...
	 */
	let testInteger = thisStorage.get('testInteger', 'Test Integer', 'Test integer description', SettingType.INTEGER, 4, {min:4, max:8});
	...
	let testArray = thisStorage.get('testArray', 'test Array', 'Cool description', SettingType.ARRAY, [1,2,3], {arrayType:SettingType.INTEGER});
	...
	let testArrayEnum = thisStorage.get('testArrayEnum', 'test Array Enum', 'Cool description', SettingType.ARRAY, ['variant 1'], {arrayType:SettingType.ENUM,enumList:['variant 1','variant 2', 'variant 3']});
	let testArrayPos = thisStorage.get('testArrayPos', 'test Array Pos', 'Cool description', SettingType.ARRAY, [[2,5,6],[3,3,3]], {arrayType:SettingType.POS});
